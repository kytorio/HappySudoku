...
import {NakedPairs, PossibleNumber} from '@sudoku/stores/strategy'
...
export function solveSudokuTest(sudoku) {
    ...
    let [test1,test2,solvename] = PossibleNumber();
    PossibleNumberGrid.set(test1)
    referenceGrid.setgrid(test2)
    let [nake1,nake2,solvename2] = NakedPairs();
    // // console.log(test1);
    // // console.log(test2);
    // return [test1, test2, strategyGrid];
    return [nake1, nake2, strategyGrid];
}
