...
export function PossibleNumber(){
    ...
    function getReferenceGrid(sudoku,rowIndex, colIndex){
        ...
        for (let num = 1; num <= SUDOKU_SIZE; num++) {
            if (sudoku[rowIndex][num] != 0) {
                ...
                newReferenceGrid[rowIndex][colIndex].add([rowIndex,num]);
            }
        } 
        ...
        for (let num = 1; num <= SUDOKU_SIZE; num++) {
            if (sudoku[num][colIndex] != 0) {
                newReferenceGrid[rowIndex][colIndex].add([num,colIndex])
            }
        } 
        ...
        for (let r = 0; r < BOX_SIZE; r++) {
            ...
            if (value !== 0) {
                ...
                newReferenceGrid[rowIndex][colIndex].add([startRow + r, startCol + c])
            }
            }
        }
    ...
    userGrid.subscribe($userGrid=>{
        ...
        const newPossibleGrid = $userGrid.map((row, rowIndex) =>
        ...
        const newReferenceGrid = newPossibleGrid.forEach((row, rowIndex) => {
        ...
        return newPossibleGrid,newReferenceGrid;
